...
mp_facedetector = mp.solutions.face_detection # type: ignore
    ...
    ########################################################################################
        ...
        if not succes_right or not succes_left:                    
            ...
            if not results_right.detections or not results_left.detections:
                ...
                depth = tri.find_depth(center_point_right, center_point_left, frame_right, frame_left, B, f, alpha) # type: ignore
